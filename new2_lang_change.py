...
class Trust_script:
    ...
    account_table = 'twitter_accounts_35'
    word_to_int_dict = {}
    int_to_word_dict = {}
    ...
    def main(self,  msg_tables, tercile=0, core_depth=2):
        ...
        self.time_user_topic = np.zeros( ( len(self.feat_tables),len(self.all_users_indices) , self.num_of_topics) )
        ...
        self.write_to_file( cos_sims_dif, 'results/'+tercile_prefix+'_cs_dif_02_'+depth_suffix+'.csv', 0.2)
    ...
    def retrieve_topics(self, core_users_list, all_users_list):
        ...
        if(self.cursor is not None):
            ...
            for i in range(1): #len(self.feat_tables)):
...
msg_tables = ["msg_1001_nrt_core_1",  "msg_1001_nrt_core_2"]
#msg_tables = ["twt_msg_1stPart", "twt_msg_2ndPart"] 
ts = Trust_script()
if args.tercile == 1:
   msg_tables.append('msg_1001_nrt_1st')
elif args.tercile == 2:
   msg_tables.append( 'msg_1001_nrt_2nd')
else:
   msg_tables.append( 'msg_1001_nrt')
   #msg_tables.append('twitter_messagesEn34')
